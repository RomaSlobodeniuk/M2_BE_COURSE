...
use Roma\Test\Model\ResourceModel\CarResource\Collection as CarCollection;
use Roma\Test\Model\ResourceModel\CarResource\CollectionFactory as CarResourceCollectionFactory;
...
class MassDelete extends BackendAction implements HttpPostActionInterface
{
     ...
     * {@inheritdoc}
     */
    const ADMIN_RESOURCE = 'Roma_Test::car_mass_delete';
